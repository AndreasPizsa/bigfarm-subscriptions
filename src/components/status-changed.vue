...
export default {
  ...
  data: () => ({
    ...
    isLoyaltySubscription: isTrue(window.location.query.loyaltysubscription) || false,
  ...
  computed: {
    ...
    heroImageUrl() {
      if (this.isLoyaltySubscription) {
        return require('@/assets/images/hero-enthusiastSubscription.jpg');
      }
    ...
    packageTitle() {
      if (this.isLoyaltySubscription) {
        return this.t('subscription_packageLoyalty_title');
      }
